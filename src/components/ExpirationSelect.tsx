    ...
    return (
        <div className="relative">
            <select
                ...
                className="w-full appearance-none bg-gray-100 dark:bg-dark-700/50 border border-gray-300 dark:border-dark-500/50 px-3 py-2 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all duration-300 cursor-pointer hover:border-gray-300 dark:border-dark-500/50"
            >
                {options.map((option) => (
                    <option
                        key={option.value}
