                ...
                <div className="flex justify-between items-center mb-4 sm:mb-6">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4">
                        {user ? (
                            <Link
                                to="/dashboard"
                                className="flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-1.5 bg-red-500 hover:bg-red-600 text-gray-900 dark:text-white transition-all duration-300 hover:scale-105 text-xs sm:text-sm"
                            >
